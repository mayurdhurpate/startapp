...
public class MainActivity extends AppCompatActivity {
    ...
    private String[] buttonNames = {"Spotify Streamer","Football Scores App","Library App","Build It Bigger","XYZ Reader","Capstone: MY OWN APP"};
    @Override
    protected void onCreate(Bundle savedInstanceState) {
       ...
       FloatingActionButton fab = (FloatingActionButton) findViewById(R.id.fab);
        ...
        buttonAdapter = new ButtonAdapter(buttonNames);
